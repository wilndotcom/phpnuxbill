...
<form class="form-horizontal" method="post" role="form" action="{$_url}paymentgateway/mpesa_c2b">
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-primary panel-hovered panel-stacked mb30" style="border-color: #8a2be2;">
                <div class="panel-heading" style="background-color: #8a2be2; color: white;">{Lang::T('M-Pesa C2B Payment Gateway')}</div>
                <div class="panel-body" style="background-color: #e6e6fa;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="mpesa_c2b_consumer_secret" name="mpesa_c2b_consumer_secret"
                                value="{$_c['mpesa_c2b_consumer_secret']}" required
                                style="background-color: #f0f8ff; border-color: #add8e6; color: #4682b4;">
